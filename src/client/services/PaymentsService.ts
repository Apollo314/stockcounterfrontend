...
export class PaymentsService {
    ...
    public paymentsPaymentAccountsList({
         ...
         */
        ordering?: 'id' | 'name' | 'created_at' | 'updated_at' | 'created_by' | 'updated_by' | '-id' | '-name' | '-created_at' | '-updated_at' | '-created_by' | '-updated_by',
        /**
    ...
    public paymentsPaymentsList({
         ...
         * Which field to use when ordering the results.
         */
        ordering?: 'id' | 'amount' | 'currency' | 'payer' | 'receiver' | 'created_at' | 'updated_at' | 'created_by' | 'updated_by' | '-id' | '-amount' | '-currency' | '-payer' | '-receiver' | '-created_at' | '-updated_at' | '-created_by' | '-updated_by',
        /**
