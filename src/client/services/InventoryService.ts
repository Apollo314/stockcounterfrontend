...
export class InventoryService {
    ...
    public inventoryItemList({
         ...
         * Which field to use when ordering the results.
         */
        ordering?: 'id' | 'name' | 'created_at' | 'buyprice' | 'sellprice' | 'updated_at' | 'category' | '-id' | '-name' | '-created_at' | '-buyprice' | '-sellprice' | '-updated_at' | '-category',
        /**
    ...
    public inventoryItemHistoryList({
         ...
         * Which field to use when ordering the results.
         */
        ordering?: 'id' | 'name' | 'created_at' | 'updated_at' | 'buyprice' | 'sellprice' | 'category' | '-id' | '-name' | '-created_at' | '-updated_at' | '-buyprice' | '-sellprice' | '-category',
        /**
         * Ara: Ürün/Hizmet, Açıklama
         */
        search?: string,
    ...
    public inventoryStockMovementList({
         ...
         * Which field to use when ordering the results.
         */
        ordering?: 'id' | 'created_at' | 'updated_at' | 'created_by' | 'updated_by' | '-id' | '-created_at' | '-updated_at' | '-created_by' | '-updated_by',
        /**
         * Ara: Ürün/Hizmet
         */
        search?: string,
