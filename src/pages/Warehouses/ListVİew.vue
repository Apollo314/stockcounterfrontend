...
import type { Warehouse } from 'src/client';

type Row = BaseRow & Warehouse;

type Column = BaseColumn<Row>;

const operation = get_operation('/inventory/warehouse/', 'get');
...
function fetcher({
  ...
  api.inventory
    .inventoryWarehouseList(queryMaker(requestPagination))
    .then((value) => {
