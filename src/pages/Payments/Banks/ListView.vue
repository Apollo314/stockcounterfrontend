...
import type { BankOut } from 'src/client';

type Row = BaseRow & BankOut;

type Column = BaseColumn<Row>;

const operation = get_operation('/payments/banks/', 'get');
...
function fetcher({
  ...
  api.payments
    .paymentsBanksList(queryMaker(requestPagination))
    .then((value) => {
