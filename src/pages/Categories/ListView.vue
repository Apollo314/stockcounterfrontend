...
type Row = BaseRow & Category;

type Column = BaseColumn<Row>;

const operation = get_operation('/inventory/category/', 'get');
...
function fetcher({
  ...
  api.inventory
    .inventoryCategoryList(queryMaker(requestPagination))
    .then((value) => {
